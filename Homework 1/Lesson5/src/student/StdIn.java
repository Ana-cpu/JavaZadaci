...
//example from site: http://www.inf.ed.ac.uk/teaching/courses/inf1/op/PastExamFiles/2010-11main/StdIn.java
...
*
* Modified to allow input from a file -- Dan Powell 2011   
*/
public final class StdIn {

	// Added by DP. Maintains state of where input is coming from
	private static boolean readingFromFile = false;
	private static boolean assumeReadingFromFile = false;
  ...
  /**
   * Code to allow a junit test to assume that the correct file
   * has been opened
   */
  public static void assumeReadingFromFile(String filename) {

      InputStream is = null;
      try {
          is = new FileInputStream(filename);
          assumeReadingFromFile = true;
  ...
  /**
   * Added code for reading from a file -- Dan Powell
   */
  public static void redirectInput(String filename) {

      if (assumeReadingFromFile) {
  ...
  public static boolean isReadingFromFile() {
